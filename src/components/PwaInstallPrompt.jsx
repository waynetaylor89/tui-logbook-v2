...
const DISMISS_KEY = "logbook-pwa-install-dismissed";
...
export default function PwaInstallPrompt() {
  ...
  return (
    <section className="ops-panel ops-fade-in rounded-2xl border border-cyan-500/40 p-3 sm:p-4" aria-label="Install app">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.14em] text-cyan-200">Install App</p>
          <p className="text-sm text-slate-200">Install the logbook for fast startup, offline access, and home-screen launch.</p>
        </div>
